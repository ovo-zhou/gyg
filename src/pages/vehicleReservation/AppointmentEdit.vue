      ...
      <table id="table1" class="main-table-httpModule" border="1">
        <tr class="table_tr_alternation">
          ...
          <td>
            <div class="td_text_style">
              <span>货主:</span>
              <label class="td_text_style2" id="hz" v-text="body_data[0].HZMC" readonly="readonly"></label>
            </div>
          </td>
          <td>
            <div class="td_text_style">
              ...
              <label class="td_text_style2" id="hydlr" v-text="body_data[0].HD" readonly="readonly"></label>
            </div>
          </td>
        </tr>
        <tr class="table_tr_item">
          ...
          <td>
            <div class="td_text_style">
              ...
              <label class="td_text_style2" id="syd" v-text="body_data[0].SYD" readonly="readonly"></label>
            </div>
          </td>
        </tr>
        <tr class="table_tr_alternation">
          ...
          <td>
            <div class="td_text_style">
              ...
              <label class="td_text_style2" id="jxs" v-text="body_data[0].JXS" readonly="readonly"></label>
            </div>
          </td>
          <td>
            <div class="td_text_style">
        ...
        <tr class="table_tr_item">
          ...
          <td>
            <div class="td_text_style">
              <span>内外贸:</span>
              <label class="td_text_style2" id="nwm" v-text="body_data[0].NWM" readonly="readonly"></label>
            </div>
          </td>
          <td>
            <div class="td_text_style">
              <span>进出口:</span>
              <label class="td_text_style2" id="jck" v-text="body_data[0].JCK" readonly="readonly"></label>
            </div>
          </td>
          <td>
            <div class="td_text_style">
...
import ADDRESINFO from "./addEditResInfo.vue";
...
.div-gjl{
    ...
    /* font-weight: 550; */
    /* font-size:16px;color:rgb(15, 44, 102); */
    /* padding-left: 200px; */
    padding:10px;
    text-align: left;
    /* border-bottom:1px solid #ccc; */
